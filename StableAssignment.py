    ...
    for i in range(1, 31):
        while True:
            ...
            if gs <= 3 and gs != 0:
                ...
                for j in range(5):
                    while True:
                        choice = int(input('Please enter a mentor Number:\n101 for A\n102 for B\n103 for C\n104 for '
                                           'D\n105 for E\n106 for F\n107 for G\n108 for H\n109 for I\n110 for I\n111 '
                                           'for J\n112 '
                                           'for K\n113 for L\n114 for M\n115 for N'))
        ...
        for key in mentor_dict:
            ...
            while len(mentor_dict[key]) > 3:
                ...
                for group in mentor_dict[key]:
                    if mentor_group_preference[int(key % 100) - 1].index(lowest_pref) < mentor_group_preference[int(key % 100) - 1].index(group):
                        lowest_pref = group
